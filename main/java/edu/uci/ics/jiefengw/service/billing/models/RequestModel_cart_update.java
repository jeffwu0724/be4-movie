...
public class RequestModel_cart_update extends RequestModel{
    @JsonCreator
    public RequestModel_cart_update(  @JsonProperty(value = "email", required = true) String email,
    ...
    public RequestModel_cart_update() {}
}
